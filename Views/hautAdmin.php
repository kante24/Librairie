        ...
        <div class="container-fluid">
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" target=_blank href="/dashboard/Librairie/Views/AccueilAdmin.php">Accueil</a>
                    </li>



                    <li class="nav-item">
                        <a class="nav-link" target=_blank href="/dashboard/Librairie/Views/adminUtilisateur.php">Modifier User</a>
                    </li>
